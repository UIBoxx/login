...
class Finetune:
    ...
    def trainpm86(self):
        ...
        input_features_normalized = min_max_scaling_groupby[0][5000:6000]  # Take 7000 data point for now
        # print(input_features_normalized)
        target_feature = min_max_scaling_groupby[1][5000:6000]
...
train_result = Finetune(epoch=100,lr_rate = 0.001,train_test_ratio= 0.2)
